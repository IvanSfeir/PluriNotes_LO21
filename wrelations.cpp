...
CentreRelations::CentreRelations(QMainWindow *parent):
    ...
    */
    ...
    afficher_relation = new QPushButton("Afficher details");
    ...
    creer_relation_orientee = new QPushButton("Creer relation orientee");
    //QObject::connect(creer_relation_orientee, SIGNAL(Clicked()),this, SLOT(creerRelationOrientee()));

    creer_relation_non_orientee = new QPushButton("Creer relation non orientee");
