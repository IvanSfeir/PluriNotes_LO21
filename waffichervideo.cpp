...
WindowAfficherVideo::WindowAfficherVideo(video* vi, QWidget* parent):
    Video(vi), QWidget(parent) {
    ...
    video_title->addWidget(video_label); video_title->addWidget(video_text);
